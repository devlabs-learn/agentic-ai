...
Use `skills/diagram-maker/references/svg-template.md` as the wrapper and replace `<!-- SVG -->`.
...
For exact Excalidraw element snippets, read `skills/diagram-maker/references/excalidraw-patterns.md`.
